...
const EXTERNAL_API_URL = getExternalApiUrl("/permisos/detalle")
...
export async function GET(request: NextRequest) {
  ...
  const permisoParam = request.nextUrl.searchParams.get("permiso_nombre")
  ...
  externalUrl.searchParams.set("permiso_nombre", permisoParam ?? "")
    ...
    return NextResponse.json(
      {
        error:
          ...
          "Error al obtener el detalle del permiso",
      },
