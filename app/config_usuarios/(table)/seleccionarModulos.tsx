...
export default function SeleccionarModulos({ initialSelected, onSave }: Props) {
  ...
  return (
    <DialogContent className="z-100 bg-background2 sm:max-w-125">
      <DialogHeader>
        ...
        <DialogDescription>
          Marque los módulos que desea asignar al grupo. La selección se
      ...
      <div className="flex flex-col gap-3">
              ...
              return (
                ...
                >
                  <Checkbox
                    checked={checked}
                    onCheckedChange={() =>
                      toggle(modulo?.nombre ? modulo?.nombre : "")
                    }
                  />
        ...
        <div className="flex items-center justify-between">
          <span className="text-sm opacity-60">
            {seleccionados.length} módulo(s) seleccionado(s)
          </span>
